...
import { MdHome, MdInbox, MdAssessment, MdLibraryBooks, MdCreditCard, MdSettings, MdSearch, MdAutoAwesome } from 'react-icons/md';
...
const NavigationBar: React.FC = () => {
  ...
  const links = [
    ...
    { title: '評価の高い映画', url: '/top_rated', IconComponent: MdAutoAwesome },
  ...
  if (state.isAuthenticated) {
    links.push({ title: 'ログアウト', url: '/logout', IconComponent: MdSettings });
  } else {
